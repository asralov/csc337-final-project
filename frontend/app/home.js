...
function showComments(postID) {
  ...
  document.getElementById(
    "commentLabel-" + postID
  ).innerHTML = `<span style="font-size: 1.8vh" onclick="hideComment('${postID}');"><i class='bx bxs-down-arrow' ></i>&nbsp;Hide Comments</span>`;
      ...
      if (comments.length == 0) {
        ...
        for (let i = 0; i < comments.length; i++) {
          content += `<div class="commentBox">
                                <div class="commentHead">@<span class="usernamePost"><strong>${
                                  comments[i].username
                                }</strong></span> ~ <span class="postDate"><em>${getTime(
